...
import com.example.ditmar.bienesyraicesgoogle.ItemMenu.LoaderImg;
import com.example.ditmar.bienesyraicesgoogle.ItemMenu.OnLoadCompleImg;

import java.util.ArrayList;

public class DetaildImg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detaild_img);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_detaild_img, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment  implements OnLoadCompleImg{
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_detaild_img, container, false);
